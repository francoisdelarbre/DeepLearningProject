...
if __name__ == "__main__":
    ...
    train_gen = DataGenerator(DATA_DIR, output_masks=OUTPUT_MASKS, batch_size=BATCH_SIZE, resolution=RESOLUTION,
                              performs_data_augmentation=True, ids_list=ids_list_train)
    val_gen = DataGenerator(DATA_DIR, output_masks=OUTPUT_MASKS, batch_size=BATCH_SIZE, resolution=RESOLUTION,
                            performs_data_augmentation=False, ids_list=ids_list_val)
